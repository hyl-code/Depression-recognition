...
audio是存语音的三类特征向量
"""
text_features = np.load("E:/大创/Depression-recognition/reg_feature/predict_text.npz")['arr_0']
audio_features = np.squeeze(np.load("E:/大创/Depression-recognition/reg_feature/feature.npz")['arr_0'], axis=2)
...
文本综合模型和语音综合模型
"""
text_model_paths = ['E:/大创/Depression-recognition/DepressionCollected/reg_feature/Bert_128_0.82_2.pt']
audio_model_paths = ['E:/大创/Depression-recognition/DepressionCollected/reg_feature/resnet18_0.91_3.pt']
resnet = torch.load(audio_model_paths[0])
bigru = torch.load(text_model_paths[0])
x_text = []
x_audio = []
...
保存融合特征
"""
np.save('E:/大创/Depression-recognition/reg_feature/fuse_features', x_new_train.cpu().detach().numpy())
